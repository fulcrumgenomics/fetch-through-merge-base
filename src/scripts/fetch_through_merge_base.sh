...
git fetch --progress --quiet --depth=1 --update-shallow origin "$GITHUB_BASE_REF:__github_base_ref__";
git fetch --progress --quiet --depth=1 --update-shallow origin "$GITHUB_HEAD_REF:__github_head_ref__";
